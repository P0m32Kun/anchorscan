...
- [x] **Step 1: 用内联 Markdown fixture 写失败测试**
...
- [x] **Step 2: 对已合并手册做一次手工 smoke test**
...
- [x] **Step 3: 勾选实际完成的 OpenSpec 任务并提交验证记录**
